<div>
    <div  tabindex="-1"
          class="  z-50  w-full overflow-x-hidden overflow-y-auto md:inset-0  max-h-full direction-rtl" style="direction: rtl">
        <div class="relative w-full max-w-md max-h-full">
            <!-- Modal content -->
            <div class="relative self-center bg-white rounded-lg shadow dark:bg-gray-700">
