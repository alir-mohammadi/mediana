...
use App\Packages\Mediana\Model\InboxResponse;
...
/**
    ...
    {
        [$response] = $this->createPatternWithHttpInfo($pattern_to_create, $contentType);
        return $response;
    }
    ...
    {
        [$response] = $this->fetchInboxMessagesWithHttpInfo($page, $limit, $contentType);
        return $response;
    }
    ...
    {
        $returnType = InboxResponse::class;
        $request = $this->fetchInboxMessagesRequest($page, $limit, $contentType);
    ...
    {
        [$response] = $this->getMessageRecipientsStatusWithHttpInfo($bulk_id, $page, $limit, $contentType);
        return $response;
    }
    ...
    {
        [$response] = $this->getSMSWithHttpInfo($bulk_id, $contentType);
        return $response;
    }
    ...
    {
        [$response] = $this->sendPatternWithHttpInfo($pattern_to_send, $contentType);
        return $response;
    }
     ...
     * Operation sendSMS
     *
     * @param  MessageToSend $message_to_send parameters (required)
     ...
     * @throws \InvalidArgumentException
     * @return SmsResponse|ErrorResponse
     */
    public function sendSMS($message_to_send, string $contentType = self::contentTypes['sendSMS'][0])
    {
        [$response] = $this->sendSMSWithHttpInfo($message_to_send, $contentType);
        return $response;
    }
