...
namespace App\Packages\Mediana\Api;
...
use App\Packages\Mediana\ApiException;
use App\Packages\Mediana\Configuration;
use App\Packages\Mediana\HeaderSelector;
use App\Packages\Mediana\ObjectSerializer;
...
/**
     ...
     *
     * @param  \App\Packages\Mediana\Model\PatternToCreate $pattern_to_create parameters (required)
     ...
     *
     * @throws \App\Packages\Mediana\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \App\Packages\Mediana\Model\CreatePatternResponse|\App\Packages\Mediana\Model\ErrorResponse
     */
     ...
     * @throws \App\Packages\Mediana\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\Packages\Mediana\Model\CreatePatternResponse|\App\Packages\Mediana\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPatternWithHttpInfo($pattern_to_create, string $contentType = self::contentTypes['createPattern'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\App\Packages\Mediana\Model\CreatePatternResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\App\Packages\Mediana\Model\CreatePatternResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\App\Packages\Mediana\Model\CreatePatternResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
                    if ('\App\Packages\Mediana\Model\ErrorResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\App\Packages\Mediana\Model\ErrorResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\App\Packages\Mediana\Model\ErrorResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\App\Packages\Mediana\Model\CreatePatternResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\Packages\Mediana\Model\CreatePatternResponse',
                ...
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\Packages\Mediana\Model\ErrorResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \App\Packages\Mediana\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \App\Packages\Mediana\Model\InboxResponse|\App\Packages\Mediana\Model\ErrorResponse
     */
     ...
     * @throws \App\Packages\Mediana\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\Packages\Mediana\Model\InboxResponse|\App\Packages\Mediana\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchInboxMessagesWithHttpInfo($page = null, $limit = null, string $contentType = self::contentTypes['fetchInboxMessages'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\App\Packages\Mediana\Model\InboxResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\App\Packages\Mediana\Model\InboxResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\App\Packages\Mediana\Model\InboxResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\App\Packages\Mediana\Model\InboxResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\Packages\Mediana\Model\InboxResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \App\Packages\Mediana\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \App\Packages\Mediana\Model\UserResponse|\App\Packages\Mediana\Model\ErrorResponse
     */
     ...
     * @throws \App\Packages\Mediana\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\Packages\Mediana\Model\UserResponse|\App\Packages\Mediana\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAuthorizedUserWithHttpInfo(string $contentType = self::contentTypes['getAuthorizedUser'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\App\Packages\Mediana\Model\UserResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\App\Packages\Mediana\Model\UserResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\App\Packages\Mediana\Model\UserResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\App\Packages\Mediana\Model\UserResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\Packages\Mediana\Model\UserResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \App\Packages\Mediana\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \App\Packages\Mediana\Model\CreditResponse|\App\Packages\Mediana\Model\ErrorResponse
     */
     ...
     * @throws \App\Packages\Mediana\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\Packages\Mediana\Model\CreditResponse|\App\Packages\Mediana\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCreditWithHttpInfo(string $contentType = self::contentTypes['getCredit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\App\Packages\Mediana\Model\CreditResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\App\Packages\Mediana\Model\CreditResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\App\Packages\Mediana\Model\CreditResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\App\Packages\Mediana\Model\CreditResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\Packages\Mediana\Model\CreditResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \App\Packages\Mediana\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \App\Packages\Mediana\Model\RecipientResponse|\App\Packages\Mediana\Model\ErrorResponse
     */
     ...
     * @throws \App\Packages\Mediana\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\Packages\Mediana\Model\RecipientResponse|\App\Packages\Mediana\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMessageRecipientsStatusWithHttpInfo($bulk_id, $page = null, $limit = null, string $contentType = self::contentTypes['getMessageRecipientsStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\App\Packages\Mediana\Model\RecipientResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\App\Packages\Mediana\Model\RecipientResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\App\Packages\Mediana\Model\RecipientResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\App\Packages\Mediana\Model\RecipientResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\Packages\Mediana\Model\RecipientResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \App\Packages\Mediana\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \App\Packages\Mediana\Model\MessageResponse|\App\Packages\Mediana\Model\ErrorResponse
     */
     ...
     * @throws \App\Packages\Mediana\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\Packages\Mediana\Model\MessageResponse|\App\Packages\Mediana\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSMSWithHttpInfo($bulk_id, string $contentType = self::contentTypes['getSMS'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\App\Packages\Mediana\Model\MessageResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\App\Packages\Mediana\Model\MessageResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\App\Packages\Mediana\Model\MessageResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\App\Packages\Mediana\Model\MessageResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\Packages\Mediana\Model\MessageResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \App\Packages\Mediana\Model\PatternToSend $pattern_to_send parameters (required)
     ...
     * @throws \App\Packages\Mediana\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \App\Packages\Mediana\Model\SmsResponse|\App\Packages\Mediana\Model\ErrorResponse
     */
     ...
     * @throws \App\Packages\Mediana\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\Packages\Mediana\Model\SmsResponse|\App\Packages\Mediana\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendPatternWithHttpInfo($pattern_to_send, string $contentType = self::contentTypes['sendPattern'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\App\Packages\Mediana\Model\SmsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\App\Packages\Mediana\Model\SmsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\App\Packages\Mediana\Model\SmsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\App\Packages\Mediana\Model\SmsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\Packages\Mediana\Model\SmsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Operation sendSMS
     *
     * @param  \App\Packages\Mediana\Model\MessageToSend $message_to_send parameters (required)
